...
class ToggleMapping2D(Layer):
    ...
    '''
    def __init__(self, num_filters, kernel_size, steps=5, strides=(1, 1), padding='same', kernel_initializer='Zeros',kernel_constraint=None,kernel_regularization=None,**kwargs)
